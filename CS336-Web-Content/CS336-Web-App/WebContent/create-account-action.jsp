...
<body>
    ...
    try {
        ...
        if(checkUsername.next()) {
            ...
            out.println("<br> <a href='createaccount.jsp'>Return to account creation page</a>");
        	out.println("<br> <a href='login.jsp'>Return to login page</a>");
            ...
            response.sendRedirect("account-creation-success.html");
        }

        
        

        // I'll decide if I want this
        /* 
        if(password.equals(password.toLowerCase())) {
            session.setAttribute("alertMsg", "Password is incorrect format. Please change your password.");
            response.sendRedirect("account-creation-failure.jsp");
        ...
        */
        ...
        out.print(e);
        //session.setAttribute ("alertMsg", "Account creation failed.");
        //response.sendRedirect("account-creation-failure.jsp");
