...
<body>
    <% 
        try {
            ...
            String searchCommand = "SELECT username, password from Employee WHERE username ='" + username + "' and password = '" + password + "' and role = 'Representative';";
            ...
            if(checkUsername.next()) {
                ...
                response.sendRedirect("CustomerRepresentative-main-page.jsp");//TODO need updated >> customer representative main page (done)
            } else {
                out.println("Invalid password. <a href='CustomerRepresentative-Login.jsp'>Return to login screen</a>");
            }
            checkUsername.close();
            stmt.close();
            conn.close();
